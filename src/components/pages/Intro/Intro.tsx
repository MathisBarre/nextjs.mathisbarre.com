  ...
  return (
    <section>
      ...
      <p className="text-gray-200 ">
        Je suis un jeune développeur web et mobile français qui passe du temps à faire <a className="link" href="https://www.youtube.com/channel/UCl3-1zqMl6YkRx0OQ3KwC_g">du contenu</a> et <a className="link" href="https://devs.coffee">des projets</a> sur mon temps libre ! J'ai récemment appris le développement mobile, et je me spécialise dans le développement front-end en explorant les tests, l'architecture, . Mon prochain objectif est de devenir plus polyvalent en maitrisant aussi le développement back-end.
      </p>
    </section>
  )
}